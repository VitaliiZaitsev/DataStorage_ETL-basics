...
CREATE TABLE sae.NATION  (NATION_bk  INTEGER NOT NULL,
...
CREATE TABLE sae.REGION  (REGION_bk  INTEGER NOT NULL,
                      NAME       CHAR(25) NOT NULL,
                      COMMENT    VARCHAR(152),
					  launch_id    INTEGER NOT NULL DEFAULT -100,
					  effective_dttm timestamp default now());

CREATE TABLE sae.PART  (PART_bk     INTEGER NOT NULL,
...
CREATE TABLE sae.SUPPLIER ( supplier_bk     INTEGER NOT NULL,
                        NAME         CHAR(25) NOT NULL,
...
CREATE TABLE sae.PARTSUPP ( PART_bk     INTEGER NOT NULL,
...
CREATE TABLE sae.CUSTOMER ( CUSTomer_bk     INTEGER NOT NULL,
...
CREATE TABLE sae.ORDERS  ( orders_bk       INTEGER NOT NULL,
...
CREATE TABLE sae.LINEITEM ( orders_bk    INTEGER NOT NULL,
